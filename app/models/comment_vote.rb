class CommentVote < ApplicationRecord
  ...
  belongs_to :comment
  belongs_to_creator
  validates_presence_of :creator_id, :comment_id, :score
  validates_uniqueness_of :creator_id, :scope => :comment_id, :message => "have already voted for this comment"
  validate :validate_creator_can_vote
  ...
  def validate_creator_can_vote
    if !creator.can_comment_vote?
