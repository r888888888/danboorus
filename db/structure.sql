...
CREATE TABLE uploads (
    ...
    backtrace text,
    post_id integer,
    sha256_confirmation character varying,
    created_at timestamp without time zone,
    updated_at timestamp without time zone,
    server text,
    parent_id integer
...
--
-- Name: index_posts_on_sha256; Type: INDEX; Schema: public; Owner: -
--

CREATE UNIQUE INDEX index_posts_on_sha256 ON posts USING btree (booru_id, sha256);
...
INSERT INTO schema_migrations (version) VALUES ('20171020165649');
